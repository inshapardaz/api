...
namespace Inshapardaz.Functions.Tests.Library.Book.GetFavoriteBooks
{
    ...
    public class WhenGettingFavoriteBooksSinglePage : LibraryTest<Functions.Library.Books.GetFavoriteBooks>
    {
        ...
        public async Task Setup()
        {
            ...
            var books = builder.AddToFavorites(claim.GetUserId(), 12).Build(40);
