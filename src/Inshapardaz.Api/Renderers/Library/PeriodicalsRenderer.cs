...
namespace Inshapardaz.Api.Renderers.Library
{
    ...
    {
        private readonly IRenderPeriodical _magazineRenderer;
        private readonly IRenderLink _linkRenderer;
        private readonly IUserHelper _userHelper;

        public PeriodicalsRenderer(IRenderLink linkRenderer, IUserHelper userHelper, IRenderPeriodical magazineRenderer)
        {
            _magazineRenderer = magazineRenderer;
        ...
        public PageView<PeriodicalView> Render(PageRendererArgs<Periodical> source)
        {
            ...
            {
                Data = source.Page.Data?.Select(x => _magazineRenderer.Render(x))
            };
        ...
        {
            return source.Select(x => _magazineRenderer.Render(x));
        }
