...
namespace Inshapardaz.Domain.Models.Library
{
    ...
    public class UpdateCorrectionRequestHandler : RequestHandlerAsync<UpdateCorrectionRequest>
    {
        ...
        {
            var result = await _correctionRepository.GetCorrection(command.Correction.Language, command.Correction.Profile, command.Correction.IncorrectText, cancellationToken);
