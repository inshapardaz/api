...
namespace Inshapardaz.Api.IntegrationTests.Dictionary.Meaning
{
    ...
    public class WhenGettingMeaningsForContext : IntegrationTestBase
    {
        ...
        public async Task Setup()
        {
            ...
            _meaning2 = MeaningDataHelper.CreateMeaning(_dictionary.Id, _word.Id, new Domain.Entities.Dictionary.Meaning { Context = "ctx2", Value = "sdsd2", Example = "None" });
            _meaning3 = MeaningDataHelper.CreateMeaning(_dictionary.Id, _word2.Id, new Domain.Entities.Dictionary.Meaning { Context = "ctx1", Value = "erer2", Example = "None" });
