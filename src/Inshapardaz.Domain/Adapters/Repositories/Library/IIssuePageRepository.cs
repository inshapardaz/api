...
namespace Inshapardaz.Domain.Adapters.Repositories.Library
{
    public interface IIssuePageRepository
    {
        ...
        Task<IssuePageModel> AddPage(int libraryId, int periodicalId, int volumeNumber, int issueNumber, int sequenceNumber, string text, long? fileId, long? chapterNumber, EditingStatus status, CancellationToken cancellationToken);
        Task<IssuePageModel> UpdatePage(int libraryId, int periodicalId, int volumeNumber, int issueNumber, int sequenceNumber, string text, long? fileId, long? chapterNumber, EditingStatus status, CancellationToken cancellationToken);
