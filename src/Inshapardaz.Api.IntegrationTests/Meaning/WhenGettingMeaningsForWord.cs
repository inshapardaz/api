...
namespace Inshapardaz.Api.IntegrationTests.Meaning
{
    ...
    public class WhenGettingMeaningsForWord : IntegrationTestBase
    {
        ...
        public async Task Setup()
        {
            ...
            _meaning1 = MeaningDataHelper.CreateMeaning(_dictionary.Id, _word.Id, new Domain.Entities.Meaning { Context = "ctx", Value = "sdsd1", Example = "None" });
            _meaning2 = MeaningDataHelper.CreateMeaning(_dictionary.Id, _word.Id, new Domain.Entities.Meaning { Context = "ctx", Value = "sdsd2", Example = "None" });
            _meaning3 = MeaningDataHelper.CreateMeaning(_dictionary.Id, _word2.Id, new Domain.Entities.Meaning { Context = "ctx", Value = "erer2", Example = "None" });
