...
{
    [TestFixture]
    public class WhenGettingBooksBySeriesAsWriter : FunctionTest
    {
        ...
        public async Task Setup()
        {
            ...
            _response = (OkObjectResult) await handler.Run(request, series.Id,  AuthenticationBuilder.WriterClaim, CancellationToken.None);
