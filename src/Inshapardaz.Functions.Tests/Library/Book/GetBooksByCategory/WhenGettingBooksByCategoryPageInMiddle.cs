...
namespace Inshapardaz.Functions.Tests.Library.Book.GetBooksByCategory
{
        ...
        : LibraryTest<Functions.Library.Books.GetBooks>
    {
        ...
        {
            _assert.ShouldHaveSelfLink($"/api/library/{LibraryId}/books", 2, parameterName: "categoryid", parameterValue: _category.Id.ToString());
        }
        ...
        {
            _assert.ShouldHaveNextLink($"/api/library/{LibraryId}/books", 3, parameterName: "categoryid", parameterValue: _category.Id.ToString());
        }

        [Test]
        public void ShouldHavePreviousLink()
        {
            _assert.ShouldHavePreviousLink($"/api/library/{LibraryId}/books", 1, parameterName: "categoryid", parameterValue: _category.Id.ToString());
        }
        ...
        {
            var expectedItems = _categoryBooks.OrderBy(a => a.Title).Skip(10).Take(10);
