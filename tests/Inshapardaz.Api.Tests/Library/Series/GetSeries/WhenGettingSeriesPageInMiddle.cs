...
{
    [TestFixture]
    public class WhenGettingSeriesPageInMiddle() : TestBase(Domain.Models.Role.Reader)
    {
        ...
        public async Task Setup()
        {
            ...
            _response = await Client.GetAsync($"/libraries/{LibraryId}/series?pageNumber=3&pageSize=10");
        ...
        [Test]
        public void ShouldHaveNextLink() => _assert.ShouldHaveNextLink($"/libraries/{LibraryId}/series", 4);

        [Test]
        public void ShouldHavePreviousLink() => _assert.ShouldHavePreviousLink($"/libraries/{LibraryId}/series", 2);

        [Test]
        public void ShouldReturnExpectedSeries()
        {
            var expectedItems = SeriesBuilder.Series.OrderBy(a => a.Name).Skip(2 * 10).Take(10);
