...
{
    [TestFixture]
    public class WhenAddingChapterAsWriter
        : LibraryTest<Functions.Library.Books.Chapters.AddChapter>
    {
        ...
        public async Task Setup()
        {
            ...
            _response = (CreatedResult)await handler.Run(chapter, LibraryId, book.Id, AuthenticationBuilder.WriterClaim, CancellationToken.None);
        }
