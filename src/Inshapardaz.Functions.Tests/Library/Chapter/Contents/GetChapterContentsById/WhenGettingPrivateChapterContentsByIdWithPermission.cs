...
namespace Inshapardaz.Functions.Tests.Library.Chapter.Contents.GetChapterContentsById
{
    ...
    public class WhenGettingPrivateChapterContentsByIdWithPermission
        : LibraryTest<Functions.Library.Books.Chapters.Contents.GetChapterContentsById>
    {
        ...
        public WhenGettingPrivateChapterContentsByIdWithPermission(AuthenticationLevel authenticationLevel)
        {
        ...
        public async Task Setup()
        {
            ...
            _response = (ObjectResult)await handler.Run(_request, LibraryId, _chapter.BookId, _chapter.Id, _content.Id, _claim, CancellationToken.None);
