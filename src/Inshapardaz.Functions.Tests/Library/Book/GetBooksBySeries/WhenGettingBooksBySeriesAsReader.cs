...
{
    [TestFixture]
    public class WhenGettingBooksBySeriesAsReader : FunctionTest
    {
        ...
        public async Task Setup()
        {
            ...
            _response = (OkObjectResult) await handler.Run(request, series.Id,  AuthenticationBuilder.ReaderClaim, CancellationToken.None);
