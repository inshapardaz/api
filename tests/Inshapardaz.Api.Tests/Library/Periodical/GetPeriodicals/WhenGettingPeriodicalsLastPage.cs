...
{
    [TestFixture]
    public class WhenGettingPeriodicalsLastPage() : TestBase(Role.Reader)
    {
        ...
        [Test]
        public void ShouldNotHavePreviousLink() => _assert.ShouldHavePreviousLink($"/libraries/{LibraryId}/periodicals");
