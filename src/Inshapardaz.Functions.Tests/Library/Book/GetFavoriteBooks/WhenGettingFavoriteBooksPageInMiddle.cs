...
namespace Inshapardaz.Functions.Tests.Library.Book.GetFavoriteBooks
{
    ...
    public class WhenGettingFavoriteBooksPageInMiddle : LibraryTest<Functions.Library.Books.GetFavoriteBooks>
    {
        ...
        public async Task Setup()
        {
            ...
            var books = builder.AddToFavorites(claim.GetUserId(), 33).Build(40);
        ...
        {
            Assert.That(_view.PageCount, Is.EqualTo(4));
            Assert.That(_view.PageSize, Is.EqualTo(10));
            Assert.That(_view.TotalCount, Is.EqualTo(33));
