...
{
    [TestFixture]
    public class WhenUploadingPeriodicalImageWhenNoExistingImage() : TestBase(Role.Writer)
    {
        ...
        [Test]
        public void ShouldHaveLocationHeader() => _assert.ShouldHaveImageLocationHeader();

        [Test]
        public void ShouldHaveAddedImageToPeriodical() => _assert.ShouldHaveAddedPeriodicalImage(_periodicalId);
