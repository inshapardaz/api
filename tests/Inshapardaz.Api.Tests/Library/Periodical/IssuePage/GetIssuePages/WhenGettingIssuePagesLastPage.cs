...
{
    [TestFixture]
    public class WhenGettingIssuePagesLastPage() : TestBase(Role.Reader)
    {
        ...
        [Test]
        public void ShouldHavePreviousLink() => _assert.ShouldHavePreviousLink($"/libraries/{LibraryId}/periodicals/{_issue.PeriodicalId}/volumes/{_issue.VolumeNumber}/issues/{_issue.IssueNumber}/pages", 2);
