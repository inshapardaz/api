...
namespace Inshapardaz.Api.Tests.Library.Chapter.GetChapterById
{
    ...
    public class WhenGettingChapterByIdHavingContentsWithWritePermissions(Role role) : TestBase(role)
    {
        ...
        [Test]
        public void ShouldHaveCorrectContents() => _assert.ShouldHaveCorrectContents();
    }
}
