...
{
    [TestFixture]
    public class WhenUpdatingChapterAsWriter
        : LibraryTest<Functions.Library.Books.Chapters.UpdateChapter>
    {
        ...
        public async Task Setup()
        {
            ...
            _response = (OkObjectResult)await handler.Run(_expected, LibraryId, chapter.BookId, chapter.Id, AuthenticationBuilder.WriterClaim, CancellationToken.None);
        }
