...
namespace Inshapardaz.Functions.Tests.Library.Book.GetBooksByCategory
{
        ...
        : LibraryTest<Functions.Library.Books.GetBooks>
    {
        ...
        public async Task Setup()
        {
            ...
            _categoryBooks = _bookBuilder.WithLibrary(LibraryId).WithCategory(_category).IsPublic().Build(23);
        ...
        {
            _assert.ShouldHaveSelfLink($"/api/library/{LibraryId}/books", 1, parameterName: "categoryid", parameterValue: _category.Id.ToString());
        }
        ...
        {
            _assert.ShouldHaveNextLink($"/api/library/{LibraryId}/books", 2, parameterName: "categoryid", parameterValue: _category.Id.ToString());
        }
