...
{
    public class WhenGettingIssuesByPeriodicalMiddlePage() : TestBase(Role.Writer)
    {
        ...
        public async Task Setup()
        {
            ...
            _response = await Client.GetAsync($"/libraries/{LibraryId}/periodicals/{_periodical.Id}/issues?pageNumber=2");
        ...
        [Test]
        public void ShouldHaveSelfLink() => _assert.ShouldHaveSelfLink($"/libraries/{LibraryId}/periodicals/{_periodical.Id}/issues");

        [Test]
        public void ShouldHavePreviousLink() => _assert.ShouldHavePreviousLink($"/libraries/{LibraryId}/periodicals/{_periodical.Id}/issues", 1);

        [Test]
        public void ShouldNotHaveNextLink() => _assert.ShouldHaveNextLink($"/libraries/{LibraryId}/periodicals/{_periodical.Id}/issues", 3);
        ...
        {
            var expectedItems = _issues.OrderBy(a => a.IssueDate).Skip(10).Take(10).ToArray();
