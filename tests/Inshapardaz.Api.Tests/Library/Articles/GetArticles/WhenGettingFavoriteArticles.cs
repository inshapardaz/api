...
{
    [TestFixture]
    public class WhenGettingFavoriteArticles : TestBase
    {
        private HttpResponseMessage _response;
        private PagingAssert<ArticleView> _assert;

        public WhenGettingFavoriteArticles()
            : base(Role.Writer)
        {
        }
        ...
        public async Task Setup()
        {
            ...
            _response = await Client.GetAsync($"/libraries/{LibraryId}/articles?pageNumber=2&pageSize=10&favorite=true");
