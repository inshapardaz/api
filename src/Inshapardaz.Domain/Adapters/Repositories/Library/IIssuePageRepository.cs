...
namespace Inshapardaz.Domain.Adapters.Repositories.Library
{
    public interface IIssuePageRepository
    {
        ...
        Task<IssuePageModel> AddPage(int libraryId, int periodicalId, int volumeNumber, int issueNumber, int sequenceNumber, string text, int? fileId, int? chapterNumber, CancellationToken cancellationToken);
        Task<IssuePageModel> UpdatePage(int libraryId, int periodicalId, int volumeNumber, int issueNumber, int sequenceNumber, string text, int? fileId, int? chapterNumber, EditingStatus status, CancellationToken cancellationToken);
        ...
        Task<IssuePageModel> UpdatePageImage(int libraryId, int periodicalId, int volumeNumber, int issueNumber, int sequenceNumber, int id, CancellationToken cancellationToken);
