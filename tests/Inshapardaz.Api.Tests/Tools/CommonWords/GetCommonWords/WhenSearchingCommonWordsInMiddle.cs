...
{
    [TestFixture]
    public class WhenSearchingCommonWordsInMiddle : TestBase
    {
        ...
        public WhenSearchingCommonWordsInMiddle()
        ...
        {
            _assert.ShouldHaveSelfLink($"/tools/{_language}/words", 3, 10, new KeyValuePair<string, string>("query", _searchedWord));
        }
        ...
        {
            _assert.ShouldHaveNextLink($"/tools/{_language}/words", 4, 10, new KeyValuePair<string, string>("query", _searchedWord));
        }

        [Test]
        public void ShouldHavePreviousLinks()
        {
            _assert.ShouldHavePreviousLink($"/tools/{_language}/words", 2, 10, new KeyValuePair<string, string>("query", _searchedWord));
        }
