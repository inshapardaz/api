...
{
    [TestFixture]
    public class WhenGettingTranslationsForWordWithNoAccess : IntegrationTestBase
    {
        ...
        public async Task Setup()
        {
            ...
            Response = await GetContributorClient(Guid.NewGuid()).GetAsync($"/api/dictionaries/{_dictionary.Id}/words/{_word.Id}/translations");
