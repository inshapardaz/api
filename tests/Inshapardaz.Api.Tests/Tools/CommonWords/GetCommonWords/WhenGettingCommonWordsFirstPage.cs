...
{
    [TestFixture]
    public class WhenGettingCommonWordsFirstPage() : TestBase(Domain.Models.Role.Reader)
    {
        ...
        [Test]
        public void ShouldHaveSelfLink() => _assert.ShouldHaveSelfLink($"/tools/{_language}/words");

        [Test]
        public void ShouldHaveNextLink() => _assert.ShouldHaveNextLink($"/tools/{_language}/words", 2);
