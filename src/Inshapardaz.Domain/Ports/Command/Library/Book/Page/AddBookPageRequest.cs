...
public class AddBookPageRequestHandler(
    IBookRepository bookRepository,
    IBookPageRepository bookPageRepository,
    IAmACommandProcessor commandProcessor)
    : RequestHandlerAsync<AddBookPageRequest>
{
    ...
    public override async Task<AddBookPageRequest> HandleAsync(AddBookPageRequest command, CancellationToken cancellationToken = new CancellationToken())
    {
        ...
        if (existingBookPage == null)
        {
            ...
            command.Result = await bookPageRepository.AddPage(command.LibraryId, command.BookPage, cancellationToken);
        ...
        {
            command.Result = await bookPageRepository.UpdatePage(command.LibraryId, 
