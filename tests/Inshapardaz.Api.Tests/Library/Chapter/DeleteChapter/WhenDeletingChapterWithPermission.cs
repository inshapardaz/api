...
namespace Inshapardaz.Api.Tests.Library.Chapter.DeleteChapter
{
    ...
    public class WhenDeletingChapterWithPermission(Role role) : TestBase(role)
    {
        ...
        [Test]
        public void ShouldHaveDeletedChapter() => _assert.ShouldHaveDeletedChapter(_expected.Id);

        [Test]
        public void ShouldHaveDeletedTheChapterContents() => _assert.ThatContentsAreDeletedForChapter(_expected.Id, _filePaths);
    }
}
