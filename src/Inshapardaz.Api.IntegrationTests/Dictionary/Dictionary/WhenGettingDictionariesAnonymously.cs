...
namespace Inshapardaz.Api.IntegrationTests.Dictionary.Dictionary
{
    ...
    public class WhenGettingDictionariesAnonymously : IntegrationTestBase
    {
        ...
        public async Task Setup()
        {
            ...
            _dictionary1 = DictionaryDataHelper.CreateDictionary(new Domain.Entities.Dictionary.Dictionary { IsPublic = true, Name = "Test1"});
            _dictionary2 = DictionaryDataHelper.CreateDictionary(new Domain.Entities.Dictionary.Dictionary { IsPublic = true, Name = "Test2"});
            _dictionary3 = DictionaryDataHelper.CreateDictionary(new Domain.Entities.Dictionary.Dictionary { IsPublic = false, Name = "Test3", UserId = Guid.NewGuid()});
