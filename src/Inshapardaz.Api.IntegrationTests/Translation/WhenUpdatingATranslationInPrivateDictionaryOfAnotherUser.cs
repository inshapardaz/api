...
{
    [TestFixture]
    public class WhenUpdatingATranslationInPrivateDictionaryOfAnotherUser: IntegrationTestBase
    {
        ...
        private Domain.Entities.Translation _oldTranslation;
        ...
        public async Task Setup()
        {
            ...
            _oldTranslation = new Domain.Entities.Translation
            {
                IsTrasnpiling = true,
            ...
            Response = await GetContributorClient(Guid.NewGuid()).PutJson($"api/dictionaries/{_dictionary.Id}/words/{_wordId}/translations/{_translationId}", _oldTranslation.Map());
