...
{
    [TestFixture]
    public class WhenGettingSeriesByIdAsWriter : FunctionTest
    {
        ...
        public async Task Setup()
        {
            ...
            _response = (OkObjectResult) await handler.Run(request, NullLogger.Instance, _selectedSeries.Id, AuthenticationBuilder.WriterClaim, CancellationToken.None);
