...
public class InternalUpdateBookImageRequest : LibraryBaseCommand
{
    public InternalUpdateBookImageRequest(int libraryId, int bookId, int? accountId)
        : base(libraryId)
    {
        BookId = bookId;
        AccountId = accountId;
...
public class InternalUpdateBookImageRequestHandler : RequestHandlerAsync<InternalUpdateBookImageRequest>
{
    private readonly IBookRepository _bookRepository;
    private readonly IAmACommandProcessor _commandProcessor;

    public InternalUpdateBookImageRequestHandler(IBookRepository bookRepository, 
    ...
    public override async Task<InternalUpdateBookImageRequest> HandleAsync(InternalUpdateBookImageRequest command, CancellationToken cancellationToken = new CancellationToken())
    {
