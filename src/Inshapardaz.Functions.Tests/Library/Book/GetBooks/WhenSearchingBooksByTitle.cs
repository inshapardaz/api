...
{
    [TestFixture]
    public class WhenSearchingBooksByTitle
        : LibraryTest<Functions.Library.Books.GetBooks>
    {
        ...
        public async Task Setup()
        {
            ...
            _builder.WithLibrary(LibraryId).IsPublic().Build(30);
        ...
        {
            _assert.ShouldHaveNextLink($"/api/library/{LibraryId}/books", 3);
        }
        ...
        {
            var expectedItems = _builder.Books.Where(b => b.Title.Contains("itle"))
