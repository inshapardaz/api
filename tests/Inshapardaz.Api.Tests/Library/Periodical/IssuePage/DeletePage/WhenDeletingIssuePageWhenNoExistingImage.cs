...
{
    [TestFixture]
    public class WhenDeletingIssuePageWhenNoExistingImage() : TestBase(Role.Writer)
    {
        ...
        [Test]
        public void ShouldDeletePage() => _assert.IssuePageShouldExist(_issueId, _page.SequenceNumber);
    }
}
