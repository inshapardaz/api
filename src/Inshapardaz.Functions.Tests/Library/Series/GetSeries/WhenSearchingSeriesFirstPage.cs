...
{
    [TestFixture]
    public class WhenSearchingSeriesFirstPage : LibraryTest<Functions.Library.Series.GetSeries>
    {
        ...
        {
            _assert.ShouldHaveNextLink($"/api/library/{LibraryId}/series", 2, 10, "query", "SearchSeries");
        }
        ...
        {
            var expectedItems = _builder.Series.Where(a => a.Name.Contains("SearchSeries")).OrderBy(a => a.Name).Take(10);
