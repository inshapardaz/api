...
{
    public class WhenGettingIssuesByPeriodicalSortedByVolumeAndIssueNumber
        : TestBase
    {
        ...
        public WhenGettingIssuesByPeriodicalSortedByVolumeAndIssueNumber()
            : base(Role.Writer)
        {
        }
        ...
        public void ShouldHaveSelfLink()
        {
            _assert.ShouldHaveSelfLink($"/libraries/{LibraryId}/periodicals/{_periodical.Id}/issues", 
                new KeyValuePair<string, string>("sortBy", "VolumeNumberAndIssueNumber"),
        ...
        {
            var expectedItems = _issues.OrderBy(a => a.VolumeNumber)
                .ThenBy(b => b.IssueNumber)
