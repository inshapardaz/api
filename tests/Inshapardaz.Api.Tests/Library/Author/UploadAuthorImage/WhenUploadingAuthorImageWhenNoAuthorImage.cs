...
{
    [TestFixture]
    public class WhenUploadingAuthorImageWhenNoAuthorImage() : TestBase(Role.LibraryAdmin)
    {
        ...
        [Test]
        public void ShouldHaveLocationHeader() => _assert.ShouldHaveCorrectImageLocationHeader(_authorId);

        [Test]
        public void ShouldHaveAddedImageToAuthor() => _assert.ShouldHaveAddedAuthorImage(_authorId, _newImage);

        [Test]
        public void ShouldSavePublicImage() => _assert.ShouldHavePublicImage(_authorId);
    }
}
