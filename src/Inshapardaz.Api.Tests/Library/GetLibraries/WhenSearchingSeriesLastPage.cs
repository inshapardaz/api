...
namespace Inshapardaz.Api.Tests.Library.GetLibraries
{
    ...
    public class WhenSearchingSeriesLastPage : TestBase
    {
        ...
        public async Task Setup()
        {
            ...
            _response = await Client.GetAsync($"/library/{LibraryId}/series?query=SearchSeries&pageNumber=5&pageSize=10");
        ...
        {
            _assert.ShouldHavePreviousLink($"/library/{LibraryId}/series", 4, 10, "query", "SearchSeries");
        }
