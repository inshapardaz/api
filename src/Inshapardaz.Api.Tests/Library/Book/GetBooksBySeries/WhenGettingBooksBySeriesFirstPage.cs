...
{
    [TestFixture]
    public class WhenGettingBooksBySeriesFirstPage
        : TestBase
    {
        ...
        public WhenGettingBooksBySeriesFirstPage()
            : base(Role.Reader)
        {
        }
        ...
        {
            _assert.ShouldHaveNextLink($"/libraries/{LibraryId}/books", 2, 10, "seriesId", _series.Id.ToString());
        }
