...
namespace Inshapardaz.Api.Tests.Library.Chapter.Contents.AddChapterContents
{
        ...
        : TestBase
    {
        ...
        public async Task Setup()
        {
            ...
            _response = await Client.PostContent($"/libraries/{LibraryId}/books/{_chapter.BookId}/chapters/{_chapter.ChapterNumber}/contents", Random.Bytes, null, Random.MimeType);
