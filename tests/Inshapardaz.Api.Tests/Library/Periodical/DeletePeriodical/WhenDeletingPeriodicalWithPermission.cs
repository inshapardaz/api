...
namespace Inshapardaz.Api.Tests.Library.Periodical.DeletePeriodical
{
    ...
    public class WhenDeletingPeriodicalWithPermission(Role role) : TestBase(role)
    {
        ...
        [Test]
        public void ShouldHaveDeletedPeriodical() => _assert.ShouldHaveDeletedPeriodical(_expected.Id);

        [Test]
        public void ShouldHaveDeletedThePriodicalImage() => _assert.ShouldHaveDeletedPeriodicalImage(_expected.Id);
        ...
        [Test]
        public void ShouldBeDeleteIssuesForPeriodical() => _assert.ShouldHaveDeletedIssuesForPeriodical(_expected.Id);
    }
}
