...
{
    [TestFixture]
    public class WhenGettingBookFileAsAdministrator : FunctionTest
    {
        ...
        public async Task Setup()
        {
            ...
            _response = (OkObjectResult)await handler.Run(request, _book.Id, AuthenticationBuilder.AdminClaim, CancellationToken.None);
