...
namespace Inshapardaz.Api.Tests.Library.Book.GetBooksBySeries
{
        ...
        : TestBase
    {
        ...
        public async Task Setup()
        {
            ...
            _response = await Client.GetAsync($"/library/{LibraryId}/books?pageNumber=3&pageSize=10&seriesid={_series.Id}");
        ...
        {
            _assert.ShouldHaveSelfLink($"/library/{LibraryId}/books", 3, 10, "seriesid", _series.Id.ToString());
        }
        ...
        {
            _assert.ShouldHavePreviousLink($"/library/{LibraryId}/books", 2, 10, "seriesId", _series.Id.ToString());
        }
