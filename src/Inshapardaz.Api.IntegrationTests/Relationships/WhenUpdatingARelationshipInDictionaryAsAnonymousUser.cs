...
{
    [TestFixture]
    public class WhenUpdatingARelationshipInDictionaryAsAnonymousUser : IntegrationTestBase
    {
        ...
        public async Task Setup()
        {
            ...
            Response = await GetContributorClient(Guid.Empty).PutJson($"api/dictionaries/{_dictionary.Id}/words/{_wordId}/relationships/{_relationshipId}", _oldRelationship.Map());
