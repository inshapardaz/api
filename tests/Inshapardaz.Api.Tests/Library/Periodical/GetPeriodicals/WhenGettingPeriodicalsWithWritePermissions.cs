...
namespace Inshapardaz.Api.Tests.Library.Periodical.GetPeriodicals
{
    ...
    public class WhenGettingPeriodicalsWithWritePermissions(Role role) : TestBase(role)
    {
        ...
        [Test]
        public void ShouldHaveSelfLink() => _assert.ShouldHaveSelfLink($"/libraries/{LibraryId}/periodicals");

        [Test]
        public void ShouldHaveCreateLink() => _assert.ShouldHaveCreateLink($"/libraries/{LibraryId}/periodicals");
