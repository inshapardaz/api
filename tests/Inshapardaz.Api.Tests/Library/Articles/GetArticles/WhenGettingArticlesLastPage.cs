...
{
    [TestFixture]
    public class WhenGettingArticlesLastPage : TestBase
    {
        private HttpResponseMessage _response;
        private PagingAssert<ArticleView> _assert;

        public WhenGettingArticlesLastPage() : base(Role.Reader)
        {
        }
        ...
        {
            _assert.ShouldHaveSelfLink($"/libraries/{LibraryId}/articles", 3, 10);
        }
        ...
        {
            _assert.ShouldHavePreviousLink($"/libraries/{LibraryId}/articles", 2);
        }
