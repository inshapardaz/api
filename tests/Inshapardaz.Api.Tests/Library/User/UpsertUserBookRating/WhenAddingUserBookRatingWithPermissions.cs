...
namespace Inshapardaz.Api.Tests.Library.User.UpsertUserBookRating
{
    ...
    public class WhenAddingUserBookRatingWithPermissions(Role role) : TestBase(role)
    {
        ...
        [Test]
        public void ShouldHaveSavedRating() => _assert.ShouldHaveSaved(_book.Id, AccountId, _payload.Value)
            .ShouldHaveBeenAdded(_book.Id, AccountId);
    }
}
