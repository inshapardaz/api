...
namespace Inshapardaz.Api.Tests.Library.Articles.UpdateArticleImage
{
    ...
    public class WhenUploadingArticleImageWithPermissions(Role role) : TestBase(role)
    {
        ...
        [Test]
        public void ShouldHaveUpdatedArticleImage() => _assert.ShouldHaveUpdatedArticleImage(_articleId, _newImage);
    }
}
