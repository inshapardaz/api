...
{
    [TestFixture]
    public class WhenGettingArticlesOrderByTitleDescending : TestBase
    {
        private HttpResponseMessage _response;
        private PagingAssert<ArticleView> _assert;

        public WhenGettingArticlesOrderByTitleDescending() : base(Role.Reader)
        {
        }
        ...
        public async Task Setup()
        {
            ...
            _response = await Client.GetAsync($"/libraries/{LibraryId}/articles?pageNumber=1&pageSize=12&sortDirection=descending");
        ...
        {
            var expectedItems = ArticleBuilder.Articles.OrderByDescending(a => a.Title).ToArray();
