...
{
    [TestFixture]
    public class WhenGettingBookFileAsUnauthorised : FunctionTest
    {
        ...
        public async Task Setup()
        {
            ...
            _response = (OkObjectResult)await handler.Run(request, _book.Id, AuthenticationBuilder.Unauthorized, CancellationToken.None);
