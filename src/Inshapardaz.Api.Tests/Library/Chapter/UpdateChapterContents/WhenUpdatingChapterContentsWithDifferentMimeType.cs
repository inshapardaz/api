...
namespace Inshapardaz.Api.Tests.Library.Chapter.Contents.UpdateChapterContents
{
        ...
        : TestBase
    {
        ...
        public async Task Setup()
        {
            ...
            _response = await Client.PutContent($"/libraries/{LibraryId}/books/{_chapter.BookId}/chapters/{_chapter.Id}/contents", _newContents, _content.Language, MimeTypes.Epub);
