...
{
    [TestFixture]
    public class WhenDeletingBookFileAsWriter : FunctionTest
    {
        ...
        public async Task Setup()
        {
            ...
            _response = (NoContentResult)await handler.Run(request, _expected.BookId, _expected.Id, AuthenticationBuilder.WriterClaim, CancellationToken.None);
        }
