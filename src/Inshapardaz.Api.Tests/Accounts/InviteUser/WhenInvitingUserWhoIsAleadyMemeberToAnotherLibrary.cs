...
{
    [TestFixture]
    public class WhenInvitingUserWhoIsAleadyMemeberToAnotherLibrary : TestBase
    {
        private HttpResponseMessage _response;
        private Dto.LibraryDto _library1, _library2;
        private Dto.AccountDto _account;

        public WhenInvitingUserWhoIsAleadyMemeberToAnotherLibrary() : base(Role.Admin)
        {
        }
        ...
        public async Task Setup()
        {
            ...
            _response = await Client.PostObject($"/api/accounts/invite/library/{_library2.Id}",
