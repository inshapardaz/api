...
{
    [TestFixture]
    public class WhenGettingTranslationsForLanguage : IntegrationTestBase
    {
        ...
        public async Task Setup()
        {
            ...
            Response = await GetContributorClient(_userId).GetAsync($"/api/dictionaries/{_dictionary.Id}/words/{_word.Id}/translations/languages/6");
        ...
        [Test]
        public void ShouldNotContainTranslationForTheWordWithDifferentLanguage()
        {
            _view.ShouldNotContain(m => m.Id == _translation2.Id);
        }
