...
{
    [TestFixture]
    public class WhenGettingBooksReadbyMultipleUsers() : TestBase(Role.Reader)
    {
        ...
        [Test]
        public void ShouldHaveNextLink() => _assert.ShouldHaveNextLink($"/libraries/{LibraryId}/books", 2, 12);
