...
public class InternalUpdateBookImageRequest(int libraryId, int bookId, int? accountId) : LibraryBaseCommand(libraryId)
{
...
public class InternalUpdateBookImageRequestHandler(
    IBookRepository bookRepository,
    IAmACommandProcessor commandProcessor)
    : RequestHandlerAsync<InternalUpdateBookImageRequest>
{
