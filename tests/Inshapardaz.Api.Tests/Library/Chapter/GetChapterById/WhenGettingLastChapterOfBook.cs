...
{
    [TestFixture]
    public class WhenGettingLastChapterOfBook() : TestBase(Role.Reader)
    {
        ...
        [Test]
        public void ShouldHavePreviousLink() => _assert.ShouldHavePreviousLink(_expected.ChapterNumber - 1);

        [Test]
        public void ShouldNotHaveNextLink() => _assert.ShouldHaveNotNextLink();
    }
}
