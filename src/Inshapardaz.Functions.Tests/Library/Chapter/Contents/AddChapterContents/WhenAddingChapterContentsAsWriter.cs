...
{
    [TestFixture]
    public class WhenAddingChapterContentsAsWriter : FunctionTest
    {
        ...
        public async Task Setup()
        {
            ...
            _response = (CreatedResult) await handler.Run(request, chapter.BookId, chapter.Id, AuthenticationBuilder.WriterClaim, CancellationToken.None);
