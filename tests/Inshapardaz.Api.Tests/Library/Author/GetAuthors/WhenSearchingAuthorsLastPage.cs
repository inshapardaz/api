...
{
    [TestFixture]
    public class WhenSearchingAuthorsLastPage() : TestBase(Role.Reader)
    {
        ...
        public async Task Setup()
        {
            ...
            _response = await Client.GetAsync($"/libraries/{LibraryId}/authors?query=SearchAuthor&pageNumber={5}&pageSize={10}");
        ...
        [Test]
        public void ShouldHaveSelfLink() => _assert.ShouldHaveSelfLink($"/libraries/{LibraryId}/authors", new KeyValuePair<string, string>("query", "SearchAuthor"));
        ...
        [Test]
        public void ShouldHavePreviousLinks() => _assert.ShouldHavePreviousLink($"/libraries/{LibraryId}/authors", 4, 10, new KeyValuePair<string, string>("query", "SearchAuthor"));
