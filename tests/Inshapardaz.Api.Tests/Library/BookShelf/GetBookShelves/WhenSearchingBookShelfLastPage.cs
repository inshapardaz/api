...
namespace Inshapardaz.Api.Tests.Library.BookShelf.GetBookShelves
{
    ...
    public class WhenSearchingBookShelfLastPage : TestBase
    {
        ...
        {
            _assert.ShouldHavePreviousLink($"/libraries/{LibraryId}/bookshelves", 4, 10, new KeyValuePair<string, string>("query", searchTerm));
        }
