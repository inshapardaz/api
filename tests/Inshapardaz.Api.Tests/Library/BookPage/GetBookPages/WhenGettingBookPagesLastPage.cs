...
{
    [TestFixture]
    public class WhenGettingBookPagesLastPage() : TestBase(Role.Reader)
    {
        ...
        [Test]
        public void ShouldHavePreviousLink() => _assert.ShouldHavePreviousLink($"/libraries/{LibraryId}/books/{_book.Id}/pages", 2);
