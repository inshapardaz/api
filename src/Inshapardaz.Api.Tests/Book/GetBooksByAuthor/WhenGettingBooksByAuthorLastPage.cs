...
namespace Inshapardaz.Api.Tests.Library.Book.GetBooksByAuthor
{
        ...
        : TestBase
    {
        ...
        public async Task Setup()
        {
            ...
            _response = await Client.GetAsync($"/library/{LibraryId}/books?pageNumber=3&pageSize=10&authorId={_author.Id}");
        ...
        {
            _assert.ShouldHavePreviousLink($"/library/{LibraryId}/books", 2, parameterName: "authorid", parameterValue: _author.Id.ToString());
        }
