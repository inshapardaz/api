...
{
    [TestFixture]
    public class WhenGettingRelationshipsForWordFromPrivateDictionaryAnonymously : IntegrationTestBase
    {
        ...
        public async Task Setup()
        {
            ...
            Response = await GetContributorClient(Guid.Empty).GetAsync($"/api/dictionaries/{_dictionary.Id}/words/{_word.Id}/relationships");
