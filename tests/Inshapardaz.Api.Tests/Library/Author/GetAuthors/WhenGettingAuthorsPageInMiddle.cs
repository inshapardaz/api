...
{
    [TestFixture]
    public class WhenGettingAuthorsPageInMiddle() : TestBase(Role.Reader)
    {
        ...
        [Test]
        public void ShouldHaveNextLink() => _assert.ShouldHaveNextLink($"/libraries/{LibraryId}/authors", 4);

        [Test]
        public void ShouldHavePreviousLink() => _assert.ShouldHavePreviousLink($"/libraries/{LibraryId}/authors", 2);
