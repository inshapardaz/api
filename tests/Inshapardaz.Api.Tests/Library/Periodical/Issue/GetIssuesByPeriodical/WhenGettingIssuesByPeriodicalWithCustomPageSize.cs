...
{
    public class WhenGettingIssuesByPeriodicalWithCustomPageSize() : TestBase(Role.Writer)
    {
        ...
        [Test]
        public void ShouldHavePreviousLink() => _assert.ShouldHavePreviousLink($"/libraries/{LibraryId}/periodicals/{_periodical.Id}/issues", 1, 5);

        [Test]
        public void ShouldNotHaveNextLink() => _assert.ShouldHaveNextLink($"/libraries/{LibraryId}/periodicals/{_periodical.Id}/issues", 3, 5);
