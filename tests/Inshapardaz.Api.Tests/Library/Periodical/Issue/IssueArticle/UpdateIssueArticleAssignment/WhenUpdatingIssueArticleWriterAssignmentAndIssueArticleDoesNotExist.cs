...
{
    [TestFixture]
    public class WhenUpdatingIssueArticleWriterAssignmentAndIssueArticleDoesNotExist
        : TestBase
    {
        private HttpResponseMessage _response;

        public WhenUpdatingIssueArticleWriterAssignmentAndIssueArticleDoesNotExist()
            : base(Role.Writer)
        {
        }
