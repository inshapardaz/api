...
{
    [TestFixture]
    public class WhenGettingPageFromMiddleOfIssue() : TestBase(Role.Reader)
    {
        ...
        [Test]
        public void ShouldHaveNextLink() => _assert.ShouldHaveNextLinkForPageNumber(_expected.SequenceNumber + 1);
    }
}
