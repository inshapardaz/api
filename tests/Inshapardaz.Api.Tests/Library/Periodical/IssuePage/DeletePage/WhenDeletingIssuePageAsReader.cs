...
{
    [TestFixture]
    public class WhenDeletingIssuePageAsReader() : TestBase(Role.Reader)
    {
        ...
        [Test]
        public void ShouldNotDeletePage() => _assert.IssuePageShouldExist(_issueId, _page.SequenceNumber);
    }
}
