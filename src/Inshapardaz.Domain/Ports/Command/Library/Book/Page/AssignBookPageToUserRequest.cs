...
public class AssignBookPageRequest(int libraryId, int bookId, int sequenceNumber, int? accountId)
...
public class AssignBookPageRequestHandler(
    IBookRepository bookRepository,
    IBookPageRepository bookPageRepository,
    IQueryProcessor queryProcessor)
    : RequestHandlerAsync<AssignBookPageRequest>
{
