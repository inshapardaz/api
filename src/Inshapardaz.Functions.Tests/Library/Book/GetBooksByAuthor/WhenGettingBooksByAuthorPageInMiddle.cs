...
namespace Inshapardaz.Functions.Tests.Library.Book.GetBooksByAuthor
{
        ...
        : LibraryTest<Functions.Library.Books.GetBooks>
    {
        ...
        {
            _assert.ShouldHaveNextLink($"/api/library/{LibraryId}/books", 3, parameterName: "authorid", parameterValue: _author.Id.ToString());
        }

        [Test]
        public void ShouldHavePreviousLink()
        {
            _assert.ShouldHavePreviousLink($"/api/library/{LibraryId}/books", 1, parameterName: "authorid", parameterValue: _author.Id.ToString());
        }
        ...
        {
            var expectedItems = _authorBooks.OrderBy(a => a.Title).Skip(10).Take(10);
