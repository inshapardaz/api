...
namespace Inshapardaz.Api.Tests.Library.Periodical.IssuePage.UploadPageImage
{
    ...
    public class WhenUploadingIssuePageImageWithPermissions(Role role) : TestBase(role)
    {
        ...
        [Test]
        public void ShouldHaveUpdatedBookPageImage() => _assert.ShouldHaveUpdatedIssuePageImage(_issueId, _page.SequenceNumber, _newImage);
    }
}
