...
namespace Inshapardaz.Api.IntegrationTests.Dictionary.WordList
{
    ...
    public class WhenGettingWordsForDictionaryWithOneWord : IntegrationTestBase
    {
        ...
        public async Task Setup()
        {
            ...
            {
                new Domain.Entities.Dictionary.Word { Title = "abc", TitleWithMovements = "a$5fv", Attributes = GrammaticalType.FealLazim, Language = Languages.Bangali, Description = "d", Pronunciation = "p"}
            };
