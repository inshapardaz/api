...
{
    [TestFixture]
    public class WhenGettingBooksByBookShelfPageInMiddle
        : TestBase

    {
        ...
        public WhenGettingBooksByBookShelfPageInMiddle()
            : base(Role.Reader)
        {
        }
        ...
        public async Task Setup()
        {
            ...
            _response = await Client.GetAsync($"/libraries/{LibraryId}/books?pageNumber=2&pageSize=10&bookShelfId={_bookShelf.Id}");
        ...
        {
            var expectedItems = _bookShelfBooks.OrderBy(a => a.Title).Skip(10).Take(10).ToArray();
