...
{
    [TestFixture]
    public class WhenDeletingBookFileAsReader : FunctionTest
    {
        ...
        public async Task Setup()
        {
            ...
            _response = (ForbidResult)await handler.Run(request, _expected.BookId, _expected.Id, AuthenticationBuilder.ReaderClaim, CancellationToken.None);
        }
