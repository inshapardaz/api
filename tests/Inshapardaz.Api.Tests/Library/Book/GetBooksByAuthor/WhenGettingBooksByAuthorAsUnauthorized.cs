...
{
    [TestFixture]
    public class WhenGettingBooksByAuthorAsUnauthorized : TestBase
    {
        ...
        public async Task Setup()
        {
            ...
            BookBuilder.WithLibrary(LibraryId).WithAuthor(_author).IsPublic(false).Build(3);
        ...
        {
            var expectedItems = _authorBooks.Where(b => b.IsPublic).OrderBy(a => a.Title).Take(10).ToArray();
