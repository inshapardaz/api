...
{
    [TestFixture]
    public class WhenGettingBooksBySeriesAsWriter : LibraryTest<Functions.Library.Books.GetBooksBySeries>
    {
        ...
        public async Task Setup()
        {
            ...
            _response = (OkObjectResult)await handler.Run(request, LibraryId, series.Id, AuthenticationBuilder.WriterClaim, CancellationToken.None);
