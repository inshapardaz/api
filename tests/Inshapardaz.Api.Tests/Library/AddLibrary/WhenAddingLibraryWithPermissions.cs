...
{
    [TestFixture]
    public class WhenAddingLibraryWithPermissions() : TestBase(Role.Admin)
    {
        ...
        [Test]
        public void ShouldHaveCreatedLibraryInDataStore() => _assert.ShouldHaveCreatedLibraryWithConfiguration();
