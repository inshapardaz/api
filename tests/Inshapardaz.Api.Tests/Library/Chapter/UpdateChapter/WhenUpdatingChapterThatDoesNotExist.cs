...
{
    [TestFixture]
    public class WhenUpdatingChapterThatDoesNotExist() : TestBase(Role.Writer)
    {
        ...
        [Test]
        public void ShouldHaveLocationHeader() => _chapterAssert.ShouldHaveCorrectLocationHeader();

        [Test]
        public void ShouldSaveTheChapter() => _chapterAssert.ShouldHaveSavedChapter();
