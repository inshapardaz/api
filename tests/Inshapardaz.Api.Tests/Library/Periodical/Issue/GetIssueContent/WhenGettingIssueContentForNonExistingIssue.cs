...
namespace Inshapardaz.Api.Tests.Library.Periodical.Issue.GetIssueContent
{
        ...
        : TestBase
    {
        ...
        public async Task Setup()
        {
            ...
            _response = await Client.GetAsync($"/libraries/{LibraryId}/periodicals/{issue.PeriodicalId}/volumes/{issue.VolumeNumber}/issues/{-RandomData.Number}/contents/{content.Id}?language={content.Language}", content.MimeType);
        }
