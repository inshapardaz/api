...
public class AddBookRequest(int libraryId, int? accountId, BookModel book) : LibraryBaseCommand(libraryId)
{
...
public class AddBookRequestHandler(
    IBookRepository bookRepository,
    IAuthorRepository authorRepository,
    ISeriesRepository seriesRepository,
    ICategoryRepository categoryRepository)
    : RequestHandlerAsync<AddBookRequest>
{
    ...
    public override async Task<AddBookRequest> HandleAsync(AddBookRequest command, CancellationToken cancellationToken = new CancellationToken())
    {
        ...
        command.Result = await bookRepository.AddBook(command.LibraryId, command.Book, command.AccountId, cancellationToken);
