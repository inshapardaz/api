...
namespace Inshapardaz.Api.Tests.Library.Book.GetBooksBySeries
{
        ...
        : TestBase
    {
        ...
        {
            _assert.ShouldHaveSelfLink($"/libraries/{LibraryId}/books", 3, 10, "seriesid", _series.Id.ToString());
        }
        ...
        {
            _assert.ShouldHavePreviousLink($"/libraries/{LibraryId}/books", 2, 10, "seriesId", _series.Id.ToString());
        }
