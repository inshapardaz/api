...
{
    [TestFixture]
    public class WhenUpdatingARelationshipInDictionary : IntegrationTestBase
    {
        ...
        public async Task Setup()
        {
            ...
            Response = await GetContributorClient(_userId).PutJson($"api/dictionaries/{_dictionary.Id}/words/{_wordId}/relationships/{_relationshipId}", _oldRelationship.Map());
        ...
        public void Cleanup()
        {
            RelationshipDataHelper.DeleteRelationship(_dictionary.Id, _relationshipId);
        ...
        public void ShouldHaveUpdateTheTranslation()
        {
            ...
            _relation.RelationType.ShouldBe(_oldRelationship.RelationType);
        }
    }
}