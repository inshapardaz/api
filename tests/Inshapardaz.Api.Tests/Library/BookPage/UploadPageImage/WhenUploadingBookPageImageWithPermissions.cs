...
namespace Inshapardaz.Api.Tests.Library.BookPage.UploadPageImage
{
    ...
    public class WhenUploadingBookPageImageWithPermissions(Role role) : TestBase(role)
    {
        ...
        [Test]
        public void ShouldHaveUpdatedBookPageImage() => _assert.ShouldHaveUpdatedBookPageImage(_bookId, _page.SequenceNumber, _newImage);
    }
}
