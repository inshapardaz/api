...
namespace Inshapardaz.Api.Tests.Library.Series.GetSeries
{
    ...
    public class WhenSearchingSeries : TestBase
    {
        ...
        public async Task Setup()
        {
            ...
            _response = await Client.GetAsync($"/library/{LibraryId}/series?query={_searchedSeries}");
        ...
        {
            _assert.ShouldHaveSelfLink($"/library/{LibraryId}/series", "query", _searchedSeries);
        }
