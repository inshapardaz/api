...
namespace Inshapardaz.Api.Tests.Library.Book.Contents.GetBookContent
{
        ...
        : TestBase
    {
        ...
        [OneTimeSetUp]
        public async Task Setup() => _response = await Client.GetAsync($"/libraries/{LibraryId}/books/{-RandomData.Number}/content/{-RandomData.Number}?language={RandomData.Locale}", RandomData.MimeType);
