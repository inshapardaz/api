...
{
    [TestFixture]
    public class WhenDeletingARelationshipInDictionaryAsDifferentUser : IntegrationTestBase
    {
        private Domain.Entities.WordRelation _relation;
        ...
        public async Task Setup()
        {
            ...
            Response = await GetContributorClient(Guid.NewGuid()).DeleteAsync($"api/dictionaries/{_dictionary.Id}/words/{_wordId}/relationships/{_relationId}");
