...
{
    [TestFixture]
    public class WhenGettingSeriesFirstPage() : TestBase(Domain.Models.Role.Reader)
    {
        ...
        [Test]
        public void ShouldHaveNextLink() => _assert.ShouldHaveNextLink($"/libraries/{LibraryId}/series", 2);
