...
public class SqlServerDatabaseFileStorage : IFileStorage
{
    private readonly SqlServerConnectionProvider _connectionProvider;

    public bool SupportsPublicLink => false;

    public SqlServerDatabaseFileStorage(SqlServerConnectionProvider connectionProvider)
    {
    ...
    {
        return StoreFile(name, content, mimeType, cancellationToken);
    }
