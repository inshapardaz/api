...
{
    [TestFixture]
    public class WhenGettingBooksByCategoryAsUnauthorized : FunctionTest
    {
        ...
        public async Task Setup()
        {
            ...
            _response = (OkObjectResult)await handler.Run(request, category.Id, AuthenticationBuilder.Unauthorized, CancellationToken.None);
