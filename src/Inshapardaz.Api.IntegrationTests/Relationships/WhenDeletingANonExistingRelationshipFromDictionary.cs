...
{
    [TestFixture]
    public class WhenDeletingANonExistingRelationshipFromDictionary : IntegrationTestBase
    {
        ...
        public async Task Setup()
        {
            ...
            _relationship = -1234456;

            Response = await GetContributorClient(_userId).DeleteAsync($"api/dictionaries/{_dictionary.Id}/words/{_wordId}/relationships/{_relationship}");
