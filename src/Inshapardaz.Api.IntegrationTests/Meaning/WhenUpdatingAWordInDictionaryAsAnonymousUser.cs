...
{
    [TestFixture]
    public class WhenUpdatingAWordInDictionaryAsAnonymousUser : IntegrationTestBase
    {
        ...
        public async Task Setup()
        {
            ...
            Response = await GetClient().PutJson($"/api/dictionaries/{_dictionary.Id}/words/{_word.Id}", _word.Map());
