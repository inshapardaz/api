...
namespace Inshapardaz.Functions.Tests.Library.Series.GetSeriesById
{
    ...
    public class WhenGettingSeriesByIdAsReader : FunctionTest
    {
        ...
        public async Task Setup()
        {
            ...
            _response = (OkObjectResult)await handler.Run(request, NullLogger.Instance, _dataBuilder.Library.Id, _selectedSeries.Id, AuthenticationBuilder.ReaderClaim, CancellationToken.None);
