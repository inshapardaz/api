...
namespace Inshapardaz.Api.Tests.Library.Periodical.Issue.UploadIssueImage
{
    ...
    public class WhenUploadingIssueImageWithPermissions(Role role) : TestBase(role)
    {
        ...
        [Test]
        public void ShouldHaveUpdatedImage() => _assert.ShouldHaveUpdatedIssueImage(_issue, _newImage);
    }
}
