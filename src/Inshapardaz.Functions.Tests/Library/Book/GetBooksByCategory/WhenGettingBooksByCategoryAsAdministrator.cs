...
{
    [TestFixture]
    public class WhenGettingBooksByCategoryAsAdministrator : LibraryTest
    {
        ...
        public async Task Setup()
        {
            ...
            _response = (OkObjectResult)await handler.Run(request, LibraryId, category.Id, AuthenticationBuilder.AdminClaim, CancellationToken.None);
