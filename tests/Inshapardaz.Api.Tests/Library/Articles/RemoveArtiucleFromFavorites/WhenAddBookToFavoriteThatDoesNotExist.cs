...
{
    [TestFixture]
    public class WhenRemoveArticleFromFavoriteThatDoesNotExist() : TestBase(Role.Writer)
    {
        ...
        [Test]
        public void ShouldNotBeInFavorites() => _assert.ShouldNotBeInFavorites(_articleId, AccountId);
    }
}
