...
namespace Inshapardaz.Domain.Ports.Library
{
    ...
    public class GetBookByIdQueryHandler : QueryHandlerAsync<GetBookByIdQuery, Book>
    {
        ...
        public override async Task<Book> ExecuteAsync(GetBookByIdQuery command, CancellationToken cancellationToken = new CancellationToken())
        {
