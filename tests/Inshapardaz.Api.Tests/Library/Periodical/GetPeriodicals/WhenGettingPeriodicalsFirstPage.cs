...
{
    [TestFixture]
    public class WhenGettingPeriodicalsFirstPage() : TestBase(Role.Reader)
    {
        ...
        [Test]
        public void ShouldHaveNextLink() => _assert.ShouldHaveNextLink($"/libraries/{LibraryId}/periodicals", 2);
