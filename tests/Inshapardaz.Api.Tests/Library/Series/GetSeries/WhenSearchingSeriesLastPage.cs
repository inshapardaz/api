...
{
    [TestFixture]
    public class WhenSearchingSeriesLastPage() : TestBase(Domain.Models.Role.Reader)
    {
        ...
        [Test]
        public void ShouldHavePreviousLinks() => _assert.ShouldHavePreviousLink($"/libraries/{LibraryId}/series", 4, 10, new KeyValuePair<string, string>("query", "SearchSeries"));
