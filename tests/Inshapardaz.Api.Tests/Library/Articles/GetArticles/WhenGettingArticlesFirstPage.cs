...
{
    [TestFixture]
    public class WhenGettingArticlesFirstPage() : TestBase(Role.Reader)
    {
        ...
        [Test]
        public void ShouldHaveSelfLink() => _assert.ShouldHaveSelfLink($"/libraries/{LibraryId}/articles", 1);
        ...
        [Test]
        public void ShouldHaveNextLink() => _assert.ShouldHaveNextLink($"/libraries/{LibraryId}/articles", 2);
