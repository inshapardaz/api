...
{
    [TestFixture]
    public class WhenSearchingCommonWordsLastPage() : TestBase(Domain.Models.Role.Reader)
    {
        ...
        [Test]
        public void ShouldHaveSelfLink() => _assert.ShouldHaveSelfLink($"/tools/{_language}/words", 5, 10, new KeyValuePair<string, string>("query", _searchedWord));
        ...
        [Test]
        public void ShouldHavePreviousLinks() => _assert.ShouldHavePreviousLink($"/tools/{_language}/words", 4, 10, new KeyValuePair<string, string>("query", _searchedWord));
