...
{
    [TestFixture]
    public class WhenUpdatingBookContentWithDifferentContentType() : TestBase(Role.Writer)
    {
        ...
        [Test]
        public void ShouldHaveCorrectLanguage() => _assert.ShouldHaveCorrectLanguage(_file.Language);
