...
{
    [TestFixture]
    public class WhenGettingChapterByIdHavingContentAsReader : FunctionTest
    {
        ...
        public async Task Setup()
        {
            ...
            _response = (OkObjectResult) await handler.Run(null, _expected.BookId, _expected.Id, NullLogger.Instance, AuthenticationBuilder.ReaderClaim, CancellationToken.None);
