...
{
    [TestFixture]
    public class WhenGettingBooksByCategoryAsAdministrator : FunctionTest
    {
        ...
        public async Task Setup()
        {
            ...
            _response = (OkObjectResult)await handler.Run(request, category.Id, AuthenticationBuilder.AdminClaim, CancellationToken.None);
