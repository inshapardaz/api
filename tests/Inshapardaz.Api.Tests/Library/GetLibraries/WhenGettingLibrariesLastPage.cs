...
{
    [TestFixture]
    public class WhenGettingLibrariesLastPage() : TestBase(Role.Writer, createLibrary: false)
    {
        ...
        [Test]
        public void ShouldHaveSelfLink() => _assert.ShouldHaveSelfLink("/libraries", 3, 5);

        [Test]
        public void ShouldNotHaveCreateLink() => _assert.ShouldNotHaveCreateLink();

        [Test]
        public void ShouldHavePreviousLink() => _assert.ShouldHavePreviousLink("/libraries", 2, 5);
