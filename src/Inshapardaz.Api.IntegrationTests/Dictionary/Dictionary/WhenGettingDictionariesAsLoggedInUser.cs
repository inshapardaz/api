...
namespace Inshapardaz.Api.IntegrationTests.Dictionary.Dictionary
{
    ...
    public class WhenGettingDictionariesAsLoggedInUser : IntegrationTestBase
    {
        ...
        private Domain.Entities.Dictionary.Dictionary _dictionary1;
        private Domain.Entities.Dictionary.Dictionary _dictionary2;
        private Domain.Entities.Dictionary.Dictionary _dictionary3;
        private Domain.Entities.Dictionary.Dictionary _dictionary4;
        ...
        public async Task Setup()
        {
            ...
            _dictionary1 = DictionaryDataHelper.CreateDictionary(new Domain.Entities.Dictionary.Dictionary { IsPublic = true, Name = "Test1", UserId = user1 });
            _dictionary2 = DictionaryDataHelper.CreateDictionary(new Domain.Entities.Dictionary.Dictionary { IsPublic = false, Name = "Test2", UserId = user1 });
            _dictionary3 = DictionaryDataHelper.CreateDictionary(new Domain.Entities.Dictionary.Dictionary { IsPublic = false, Name = "Test3", UserId = user2 });
            _dictionary4 = DictionaryDataHelper.CreateDictionary(new Domain.Entities.Dictionary.Dictionary { IsPublic = true, Name = "Test4", UserId = user2 });
