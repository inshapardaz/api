...
namespace Inshapardaz.Functions.Tests.Library.Book.GetBooksByCategory
{
        ...
        : LibraryTest<Functions.Library.Books.GetBooks>
    {
        ...
        {
            _assert.ShouldHaveSelfLink($"/api/library/{LibraryId}/books", 3, parameterName: "categoryid", parameterValue: _category.Id.ToString());
        }
        ...
        {
            _assert.ShouldHavePreviousLink($"/api/library/{LibraryId}/books", 2, parameterName: "categoryid", parameterValue: _category.Id.ToString());
        }
