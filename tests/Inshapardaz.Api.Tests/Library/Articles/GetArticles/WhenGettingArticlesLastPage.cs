...
{
    [TestFixture]
    public class WhenGettingArticlesLastPage() : TestBase(Role.Reader)
    {
        ...
        public async Task Setup()
        {
            ...
            _response = await Client.GetAsync($"/libraries/{LibraryId}/articles?pageNumber=3&pageSize=10");
        ...
        [Test]
        public void ShouldHaveSelfLink() => _assert.ShouldHaveSelfLink($"/libraries/{LibraryId}/articles", 3);
        ...
        [Test]
        public void ShouldNotHavePreviousLink() => _assert.ShouldHavePreviousLink($"/libraries/{LibraryId}/articles", 2);

        [Test]
        public void ShouldReturnExpectedArticles()
        {
            var expectedItems = ArticleBuilder.Articles.OrderBy(a => a.Title).Skip(20).Take(10).ToArray();
