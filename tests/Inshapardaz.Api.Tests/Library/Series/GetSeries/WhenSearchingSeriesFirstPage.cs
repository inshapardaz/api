...
{
    [TestFixture]
    public class WhenSearchingSeriesFirstPage() : TestBase(Domain.Models.Role.Reader)
    {
        ...
        [Test]
        public void ShouldHaveNextLink() => _assert.ShouldHaveNextLink($"/libraries/{LibraryId}/series", 2, 10, new KeyValuePair<string, string>("query", "SearchSeries"));
