...
{
    [TestFixture]
    public class WhenSearchingArticlesByStatus : TestBase
    {
        private HttpResponseMessage _response;
        private PagingAssert<ArticleView> _assert;

        public WhenSearchingArticlesByStatus()
            : base(Role.Writer)
        {
        }
        ...
        public async Task Setup()
        {
            ...
            _response = await Client.GetAsync($"/libraries/{LibraryId}/articles?pageNumber=2&pageSize=10&query=itle&status=inreview");
