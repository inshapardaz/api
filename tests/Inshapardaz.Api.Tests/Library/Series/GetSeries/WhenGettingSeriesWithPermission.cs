...
namespace Inshapardaz.Api.Tests.Library.Series.GetSeries
{
    ...
    public class WhenGettingSeriesWithPermission(Role role) : TestBase(role)
    {
        ...
        [Test]
        public void ShouldHaveCreateLink() => _assert.ShouldHaveCreateLink($"/libraries/{LibraryId}/series");
