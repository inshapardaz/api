...
{
    [TestFixture]
    public class WhenGettingTranslationsForLanguageForPrivateDictionaryAsAnonymousUser : IntegrationTestBase
    {
        ...
        public async Task Setup()
        {
            ...
            var translation3 = TranslationDataHelper.CreateTranslation(_dictionary.Id, _word.Id, new Domain.Entities.Translation { Language = Languages.Arabic, Value = "sdsd3", IsTrasnpiling = true });


            Response = await GetContributorClient(Guid.Empty).GetAsync($"/api/dictionaries/{_dictionary.Id}/words/{_word.Id}/translations/languages/6");
