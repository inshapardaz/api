...
{
    [TestFixture]
    public class WhenSearchinArticlesWithMultipleAuthorsAndCategories() : TestBase(Role.Reader)
    {
        ...
        [Test]
        public void ShouldHaveSelfLink() => _assert.ShouldHaveSelfLink($"/libraries/{LibraryId}/articles", 2);

        [Test]
        public void ShouldHaveNextLink() => _assert.ShouldHaveNextLink($"/libraries/{LibraryId}/articles", 3);

        [Test]
        public void ShouldHavePreviousLink() => _assert.ShouldHavePreviousLink($"/libraries/{LibraryId}/articles", 1);
