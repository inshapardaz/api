...
{
    [TestFixture]
    public class WhenGettingBookPagesUnassigned() : TestBase(Role.Reader)
    {
        ...
        public async Task Setup()
        {
            ...
            _book = BookBuilder.WithLibrary(LibraryId).WithPages(20).AssignPagesToWriter(account.Id, 4).Build();
